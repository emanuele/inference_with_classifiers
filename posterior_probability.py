...
def compute_log_posteriors(X, partitions, alpha, prior_H):
    ...
    return log_posterior_H_given_X
...
if __name__ == '__main__':
    ...
    log_posterior_H_given_X = compute_log_posteriors(X, partitions, alpha, prior_H)
